...
test.describe('Autenticação', () => {
  test('deve autenticar com credenciais válidas e redirecionar para home', async ({ page, credentials }) => {
    await page.goto('/');
  ...
  test('deve redirecionar usuário autenticado ao acessar /', async ({ authenticatedPage, page }) => {
    await page.goto('/');
