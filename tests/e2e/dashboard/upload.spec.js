...
test.describe('Dashboard de upload', () => {
  test('deve processar upload de arquivo e concluir status', async ({ authenticatedPage, page }) => {
  ...
  test('deve sinalizar erro para arquivo maior que 10MB', async ({ authenticatedPage, page }) => {
    await page.goto('/dashboard');
