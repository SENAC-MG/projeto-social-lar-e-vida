...
function ScreenshotPlaceholder({ icon: Icon, label, width = "full", height = "h-48" }) {
  return (
    <div
      className={`w-${width} ${height} rounded-lg border-2 border-dashed border-card-border bg-foreground/5 flex flex-col items-center justify-center gap-3 my-4`}
    >
      <div className="p-4 bg-[#5C7A53]/10 rounded-full">
        <Icon size={40} className="text-[#5C7A53]" />
      </div>
      <p className="text-foreground/40 text-sm font-medium text-center px-4">{label}</p>
    </div>
  );
}

// ─── Componente de tabela de atalhos ─────────────────────────────────────────
            ...
            <div className="flex-1 min-w-0 space-y-6 max-w-4xl">
              ...
              {activeSection === "visao-geral" && (
                <>
                  ...
                  <CollapsibleSection title="Arquitetura do Sistema" icon={Layers} defaultOpen={true}>
                    <p className="text-foreground/70 text-sm leading-relaxed mb-4">
                      O sistema foi construído sobre uma arquitetura moderna e escalável, dividida
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                      <div className="bg-foreground/5 rounded-lg p-4 border border-card-border">
                        <div className="flex items-center gap-2 mb-2">
                          <Monitor size={16} className="text-[#5C7A53]" />
                          <h4 className="font-semibold text-sm text-foreground">Frontend</h4>
                        </div>
                        <p className="text-xs text-foreground/60">
                          Interface web responsiva construída com Next.js 14, React e Tailwind CSS.
                          Suporte a temas claro/escuro e design adaptativo para desktop e mobile.
                        </p>
                      </div>

                      <div className="bg-foreground/5 rounded-lg p-4 border border-card-border">
                        <div className="flex items-center gap-2 mb-2">
                          <Database size={16} className="text-[#5C7A53]" />
                          <h4 className="font-semibold text-sm text-foreground">Backend</h4>
                        </div>
                        <p className="text-xs text-foreground/60">
                          API em Next.js com Prisma ORM para comunicação com banco de dados SQLite.
                          Validação de dados, sanitização e tratamento de erros integrados.
                        </p>
                      </div>

                      <div className="bg-foreground/5 rounded-lg p-4 border border-card-border">
                        <div className="flex items-center gap-2 mb-2">
                          <Shield size={16} className="text-[#5C7A53]" />
                          <h4 className="font-semibold text-sm text-foreground">Segurança</h4>
                        </div>
                        <p className="text-xs text-foreground/60">
                          Autenticação de sessão, proteção contra XSS via sanitização de entradas,
                          validação de payload e controle de acesso por rotas.
                        </p>
                      </div>
                    </div>
                  </CollapsibleSection>
                ...
                <>
                  ...
                  >
                    <ScreenshotPlaceholder
                      icon={Hospital}
                      label="[Ilustração] Tela de listagem de funcionários com botão 'Novo Funcionário'"
                    />
              ...
              {activeSection === "pacientes" && (
                <>
                  ...
                  >
                    <ScreenshotPlaceholder
                      icon={Users}
                      label="[Ilustração] Tela de listagem de pacientes com botão 'Novo Paciente'"
                    />
              ...
              {activeSection === "emprestimos" && (
                <>
                  ...
                  >
                    <ScreenshotPlaceholder
                      icon={Package}
                      label="[Ilustração] Modal de novo empréstimo com busca de paciente por CPF"
                    />
