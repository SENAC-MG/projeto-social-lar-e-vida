...
import { cadastrar_Material } from "@modulos/materiais/controller/materialController";

export default function ModalNovoMaterial({ onClose, onSuccess }) {
    ...
    async function handleSubmit(e) {
        ...
        const res = await cadastrar_Material(formData);

        if (res.success) {
            toast.success(res.message || "Material cadastrado com sucesso!");
            onSuccess?.();
            onClose();
        } else {
            toast.error(res.error || "Erro ao cadastrar material.");
        }
    ...
    return (
        <Modal title="Novo Material" onClose={onClose} headerClassName="bg-[--card-bg]">
            <form
                    ...
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-12 flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                placeholder="Ex: Cadeira de rodas com estofado"
                        ...
                        <div className="col-span-12 flex flex-col gap-1.5">
                            ...
                            <textarea
                                name="descricao"
                                rows="3"
                                placeholder="Descreva detalhes do material"
