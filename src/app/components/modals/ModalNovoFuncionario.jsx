            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-12 md:col-span-8 flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground/70">
                  Nome Completo <span className="text-[#5C7A53]">*</span>
                </label>
                <input
                  name="nome"
                  type="text"
              ...
              <div className="col-span-12 md:col-span-4 flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground/70">
                  Cargo <span className="text-[#5C7A53]">*</span>
                </label>
                <input
                  name="cargo"
                  type="text"
              ...
              <div className="col-span-12 md:col-span-6 flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground/70">
                  Email <span className="text-[#5C7A53]">*</span>
                </label>
                <input
                  name="email"
                  type="email"
              ...
              <div className="col-span-12 md:col-span-6 flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground/70">
                  Telefone <span className="text-[#5C7A53]">*</span>
                </label>
                <input
                  name="telefone"
                  type="text"
