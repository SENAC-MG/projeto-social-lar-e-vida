                ...
                >
                    <form action={logoutAction}>
                        <button
                            type="submit"
                            title="Sair"
                            className={`flex items-center w-full py-2 rounded-lg transition-colors hover:bg-red-500/10 hover:text-red-500 ${isOpen ? "gap-3 px-4" : "justify-center"
                                }`}
                            style={{ color: textColor }}
                        >
                    ...
                    <button
                        ...
                        className={`flex items-center py-2 transition-colors rounded-lg ${isOpen ? "gap-3 px-4" : "justify-center"
                    ...
                    >
                        <span className="relative flex h-6 w-11 flex-shrink-0 items-center rounded-full bg-foreground/15 transition-colors duration-300">
                            <span
                                className={`absolute h-5 w-5 rounded-full bg-[#0F766E] transition-transform duration-300 ease-out ${isDark ? "translate-x-5" : "translate-x-1"
                                    }`}
                            />
