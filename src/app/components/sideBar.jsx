...
export default function Sidebar({ isOpen, toggleSidebar }) {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 min-h-screen flex flex-col p-4 transition-all duration-300 z-50
    bg-background
    ${
        isOpen
            ? "w-64 translate-x-0"
  ...
  `}
            ...
            >
                ...
                <div className="mt-auto border-t pt-4 flex flex-col gap-2" style={{ borderColor }}>
                    <LogoutButton />
                    ...
                    >
                        ...
                        {isOpen && (
                            <span className="font-medium text-sm truncate">{toggleLabel}</span>
                        )}
                    </button>
                </div>
            </aside>
