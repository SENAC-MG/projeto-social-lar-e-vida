...
export default function ModalEditarServico({ servico, onClose, onSuccess }) {
    ...
    const [unidadeSelecionada, setUnidadeSelecionada] = useState(servico.unidade || "");
    ...
    return (
        <Modal title="Editar Serviço" onClose={onClose}>
            <form
                ...
                className="bg-[#F7F9FC] dark:bg-background p-6 space-y-6 overflow-y-auto max-h-[80vh] custom-scrollbar"
            >
                ...
                <div className="flex gap-3 pt-4 border-t border-border">
                    <button
                        type="submit"
                        disabled={loading}
                        className="flex items-center gap-2 !bg-primary hover:!bg-primary/90 dark:text-white px-8 py-2.5 rounded-lg font-bold transition-all shadow-lg shadow-primary/20 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        <Save size={18} />
